...
public class Barrier2Script : MonoBehaviour
{
    [SerializeField] private float MAX_HP;
    [SerializeField] private float DAMAGE_TAKEN;
    [SerializeField] private float barrier2Hp;
    ...
    void Start()
    {
        ...
        barrierSpawnLoc1 = new Vector3(4.88f, 7.797038f, -2.391f);
        barrierSpawnLoc2 = new Vector3(4.88f, 7.797038f, -4.2f);
    ...
    void Update()
    {
        ...
        if (tickTimer >= tickTimerMax)
        {
            tickTimer = 0;
            tick++;
            if (underAttack == true && barrier2Hp > -1)
                barrier2Hp -= DAMAGE_TAKEN;
        }
